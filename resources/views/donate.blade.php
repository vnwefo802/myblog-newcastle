@extends('layouts.app') @section('title', 'Donate') @section('content')
...
<div class="block">
    ...
    <div class="mx-5 md:mx-20 my-10">
        ...
        <p class="text-sm md:text-lg text-slate-600 text-center md:text-left">
            <span class="text-lg md:text-xl text-slate-700 font-semibold">{{ $alldonate->donate_first_project__short_title }}</span><br> {{ $alldonate->donate_second_project__short_title }}
            <br><br>
            <span class="text-lg md:text-xl text-slate-700 font-semibold">{{ $alldonate->donate_first_project__long_description }}</span><br> {{ $alldonate->donate_second_project__long_description }}
        </p>
    </div>
