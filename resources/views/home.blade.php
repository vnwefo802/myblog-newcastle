...
@section('content')
    ...
    <!-- boxes -->
    <div class="w-full">
        <div class="py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl lg:py-20 border-b-4 border-zinc-300  my-8">
            <div class="grid gap-4 row-gap-5 sm:grid-cols-2 lg:grid-cols-4">
                <!-- first box -->
                <div class="flex flex-col justify-between p-5 shadow-md shadow-zinc-300 rounded border">
                    <div>
                        {!! $allhome->box_title_1 !!}
                    </div>
                </div>
                <!-- second box -->
                <div class="flex flex-col justify-between p-5 shadow-md shadow-zinc-300 border">
                    <div>
                        {!! $allhome->box_title_2 !!}
                    </div>
                </div>
    ...
    <div class="w-full my-12 py-12">
        <div class="lg:max-w-screen-xl  mx-auto">
            <h1 class="uppercase text-6xl text-zinc-700 text-center mb-12 pb-12 font-medium">One of our projects</h1>
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                <div class="px-4 py-4">
                    <div class="flex flex-col">
                        ...
                        <button class="self-start px-4 py-2 mt-8 text-white from-blue-500 to-green-400 bg-gradient-to-tl rounded hover:from-blue-600 hover:to-green-500">Find out more</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full px-6 py-10 text-white bg-indigo-600 lg:w-2/5 xl:py-24 xl:px-8">
            ...
            <div class="flex items-center">
                <a href="/volunteer" class="inline-block">
                    <button
                        class="flex items-center py-4 mt-12 text-sm bg-slate-800 rounded-md mr-7 px-7 lg:py-5 lg:text-lg md:text-base hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-4 focus:ring-blue-700">
                        <p class="mr-3 text-sm font-medium leading-none text-white lg:text-lg md:text-base">
                ...
                <a href="/donate" class="inline-block">
                    <button
                        class="flex items-center py-4 mt-12 text-sm bg-slate-800 rounded-md ml-7 px-7 lg:py-5 lg:text-lg md:text-base hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-4 focus:ring-blue-700">
                        <p class="mr-3 text-sm font-medium leading-none text-white lg:text-lg md:text-base">
