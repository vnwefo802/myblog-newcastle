                ...
                <div class="w-[750px] h-[175px] mr-20 border-[1px] max-h-[175px] container my-4">
                    ...
                    <div class="ml-3 mt-2 float-left">
                        ...
                        <div class="flex flex-row mt-[67px] mb-2 gap-3">
                            <div class="pt-2"><a class='text-gray-500 text-[12px]' href="#"><span class="flex">
                                ...
                                <span class="">{{ $post->created_at->diffForHumans() }}</span></span>
                            </a></div>
                            ...
                            <img src="/{{ $allhome->logo }}" class="w-20"  alt="Newcastle logo" aria-label="Newcastle logo" >
                                <span class="ml-2 pt-2">NewCastle-Founodation</span></span>
                            </a></div>
                            <div class="comments-count">
                                <a href="{{ route('posts.show', $post) }}#post-comments">
                                    <span  class="flex pt-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="w-[12x] h-[12px] mt-1 mr-1">
