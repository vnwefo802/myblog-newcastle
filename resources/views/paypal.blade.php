        ...
        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-4 offset-md-4">
                    ...
                    <input type="text" class="form-control" name="business" value="sb-d1jwb16814015@personal.example.com
                    " />
                    ...
                    <input type="text" class="form-control" name="currency_code" value="GB
                    " />
