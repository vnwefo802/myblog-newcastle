                ...
                <div class="py-16 bg-indigo-500 rounded-tl rounded-tr xl:rounded-bl xl:rounded-tr-none">
                    <div class="grid grid-cols-2 grid-rows-4 gap-1 px-8 mx-auto xl:w-5/6 xl:px-0">
                        ...
                        <div class="relative p-6 bg-purple-100 rounded shadow-lg">
                            ...
                            <h1 class="pt-4 font-bold leading-none text-gray-800 dark:text-gray-100">Total Comments</h1>
                            <h2 class="m-2 ml-5 text-lg font-semibold">
                            {{ $comment->count() }}
                            </h2>
                        </div>
                        <!-- today Authers -->
                        <div class="relative p-6 bg-orange-100 rounded shadow-lg">
                            ...
                            <h1 class="pt-4 font-bold leading-none text-gray-800 dark:text-gray-100">Roles</h1>
                        ...
                        <!-- <div class="relative p-6 bg-teal-100 rounded shadow-lg">
                            ...
                            <h1 class="pt-4 font-bold leading-none text-gray-800 dark:text-gray-100">
Contacts</h1>
                        </div> -->
                        <!-- categories -->
                        ...
                        <div class="relative p-6 rounded shadow-lg bg-slate-100">
                            ...
                            <h1 class="pt-4 font-bold leading-none text-gray-800 dark:text-gray-100">Users</h1>
