        ...
        <div class="flex-col w-full mt-8 space-y-4 lg:space-y-8 md:space-y-8 lg:mt-0 md:mt-8 ">
            ...
            <div class="flex flex-col justify-center w-full lg:flex-row md:flex-row gap-x-6">
                <div class="lg:max-w-[302px] md:max-w-[336px] max-w-[343px] w-full lg:max-h-[232px] md:max-h-[216px] max-h-[216px]  bg-gray-100 lg:py-[51px] md:py-11 py-12 px-8 ">
                    ...
                    <p class="mb-4 text-base leading-normal text-center text-gray-600">{{ $footer->contact_info }} </p>
                </div>
                <div class="lg:max-w-[302px] md:max-w-[336px] max-w-[343px] w-full lg:max-h-[232px] md:max-h-[216px] max-h-[216px] lg:py-12 md:py-11 bg-gray-100 py-8 px-8 lg:mb-0 md:mb-0">
                    ...
                    <p class="mb-4 text-base leading-normal text-center text-gray-600">{{ $footer->email }} </p>
                </div>
                <div class="lg:max-w-[302px] md:max-w-[336px] max-w-[343px] w-full lg:max-h-[232px] md:max-h-[216px] max-h-[216px] bg-gray-100 lg:py-[52px] md:py-11 py-8   px-8 ">
                    ...
                    <p class="mb-4 text-base font-semibold leading-none text-center text-gray-800">Follow Us</p>
                    <p class="text-base leading-normal text-center text-gray-600 ">And become a part of our community</p>
                </div>
            </div>
        </div>
    </div>
