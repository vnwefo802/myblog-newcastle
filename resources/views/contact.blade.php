...
<div class="text-center text-white bg-red-500 alert alert-success h-[35px]"> {{ $error }} </div>
@endforeach

@if (Session::has('success'))
<div class="text-center text-white bg-green-600 alert alert-success h-[35px]" role="alert">
    {{ Session('success') }}
</div>
@endif
            ...
            <div class="flex flex-col justify-center w-full lg:flex-row md:flex-row gap-x-6">
                <div class="flex flex-col items-start justify-center lg:flex-row gap-x-6">
                    <div class="flex items-center justify-center w-full my-12">
                        <form method="post" action="{{ route('store.contactmgs') }}" >
                            @csrf
                        <div class="px-8 py-12 bg-white rounded shadow top-40 dark:bg-gray-800 lg:px-28">
                            ...
                            <div class="items-center mt-12 md:flex">
                                ...
                                <div class="flex flex-col md:w-72">
                                    ...
                                    <input value='{{ old("first_name") }}' tabindex="0" arial-label="Please input name" type="name" name="name" require class="p-3 mt-4 text-base leading-none text-gray-900 placeholder-gray-300 bg-gray-100 border border-gray-200 rounded focus:oultine-none focus:border-indigo-700" placeholder="John" />
                                </div>
								<div class="flex flex-col md:w-72">
                                    <label class="text-base font-semibold leading-none text-gray-800 dark:text-white">Second Name</label>
                                    <input value='{{ old("last_name") }}' tabindex="0" arial-label="Please input name" type="name" name="name" require class="p-3 mt-4 text-base leading-none text-gray-900 placeholder-gray-300 bg-gray-100 border border-gray-200 rounded focus:oultine-none focus:border-indigo-700" placeholder="John" />
                                </div>
                                <div class="flex flex-col mt-4 md:w-72 md:ml-6 md:mt-0">
                                    ...
                                    <input value='{{ old("email") }}' tabindex="0" arial-label="Please input email address" type="email" require name="email" class="p-3 mt-4 text-base leading-none text-gray-900 placeholder-gray-300 bg-gray-100 border border-gray-200 rounded focus:oultine-none focus:border-indigo-700" placeholder="example@example.com" />
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="flex flex-col w-full mt-8">
                                    ...
                                    <textarea value='{{ old("message") }}' tabindex="0" aria-label="leave a message" role="textbox" type="text" name="message" require class="p-3 mt-4 text-base leading-none text-gray-900 placeholder-gray-300 bg-gray-100 border border-gray-200 rounded resize-none h-36 focus:oultine-none focus:border-indigo-700"></textarea>
                                </div>
								<div class="flex flex-col w-full mt-8">
                                    <label class="text-base font-semibold leading-none text-gray-800 dark:text-white">Subject</label>
                                    <textarea value='{{ old("subject") }}' tabindex="0" aria-label="leave a message" role="textbox" type="text" name="message" require class="p-3 mt-4 text-base leading-none text-gray-900 placeholder-gray-300 bg-gray-100 border border-gray-200 rounded resize-none h-36 focus:oultine-none focus:border-indigo-700"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-center w-full">
                                <input type="submit" class="px-10 py-4 text-base font-semibold leading-none text-white bg-indigo-700 rounded mt-9 hover:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none">
                            </div>
                        </div>
                    </form>
                    </div>
