    ...
    public function run()
    {
        ...
        $posts3 = \App\Models\Post::factory()->create(
            [
                ...
                'excerpt' => 'FUNDRAISE NEWCASTLE FOUNDATION',
                // body
                    '<h3 style="text-rendering: optimizelegibility; font-family:  font-size: 22px; letter-spacing: 0.1em; line-height: 1.55em; text-transform: uppercase; color: #e37263; margin-top: 0px; background-color: #ffffff; white-space: pre-wrap;">CHALLENGE HIGHLIGHTS:</h3>
