...
class PostFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            // body
            'body' => '<div id="yui_3_17_2_1_1655382978198_145" class="row sqs-row" style="color: #4a4a4a; font-family:  font-size: 18px; letter-spacing: 0.36px; background-color: #ffffff;">
